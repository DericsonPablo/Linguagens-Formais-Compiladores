...
public class Scanner {
	...
	static {
		...
		literals.put("true", new Integer(3));
		literals.put("false", new Integer(4));
		literals.put("program", new Integer(5));
		literals.put("var", new Integer(7));
		literals.put("begin", new Integer(8));
		literals.put("integer", new Integer(11));
		literals.put("boolean", new Integer(17));
		literals.put("goto", new Integer(18));
		literals.put("let", new Integer(19));
		literals.put("not", new Integer(20));
		literals.put("and", new Integer(23));
		literals.put("or", new Integer(24));
		literals.put("if", new Integer(25));
		literals.put("else", new Integer(26));
		...
		loop: for (;;) {
			switch (state) {
				...
				case 16:
					...
					else if (ch == 'n') {AddCh(); state = 20; break;}
					else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 17:
				...
				case 20:
					...
					else if (ch == 'd') {AddCh(); state = 21; break;}
					else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 21:
					recEnd = pos; recKind = 1;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'z') {AddCh(); state = 1; break;}
