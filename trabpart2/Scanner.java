...
public class Scanner {
	...
	static {
		...
		for (int i = 102; i <= 114; ++i) start.set(i, 1);
		for (int i = 116; i <= 122; ++i) start.set(i, 1);
		...
		literals.put("begin", new Integer(3));
		literals.put("input", new Integer(11));
	...
	Token NextToken() {
		...
		loop: for (;;) {
			switch (state) {
				...
				case 20:
					recEnd = pos; recKind = 1;
					if (ch >= 'a' && ch <= 'm' || ch >= 'o' && ch <= 'z') {AddCh(); state = 1; break;}
					else if (ch == 'n') {AddCh(); state = 22; break;}
					else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 21:
					recEnd = pos; recKind = 1;
					if (ch >= 'a' && ch <= 'g' || ch >= 'i' && ch <= 'z') {AddCh(); state = 1; break;}
					else if (ch == 'h') {AddCh(); state = 23; break;}
					else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 22:
					recEnd = pos; recKind = 1;
					if (ch >= 'a' && ch <= 'c' || ch >= 'e' && ch <= 'z') {AddCh(); state = 1; break;}
					else if (ch == 'd') {AddCh(); state = 24; break;}
					else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 23:
					recEnd = pos; recKind = 1;
					if (ch >= 'a' && ch <= 'n' || ch >= 'p' && ch <= 'z') {AddCh(); state = 1; break;}
					else if (ch == 'o') {AddCh(); state = 25; break;}
					else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 24:
					recEnd = pos; recKind = 1;
					if (ch >= 'a' && ch <= 'z') {AddCh(); state = 1; break;}
				...
				case 25:
					recEnd = pos; recKind = 1;
					if (ch >= 'a' && ch <= 'v' || ch >= 'x' && ch <= 'z') {AddCh(); state = 1; break;}
					else if (ch == 'w') {AddCh(); state = 26; break;}
					else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 26:
					recEnd = pos; recKind = 1;
					if (ch >= 'a' && ch <= 'z') {AddCh(); state = 1; break;}
					else if (ch == 'S') {AddCh(); state = 27; break;}
					else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 27:
					if (ch == 'y') {AddCh(); state = 28; break;}
					else {state = 0; break;}
				case 28:
					if (ch == 'm') {AddCh(); state = 29; break;}
					else {state = 0; break;}
				case 29:
					if (ch == 'b') {AddCh(); state = 30; break;}
					else {state = 0; break;}
				case 30:
					if (ch == 'o') {AddCh(); state = 31; break;}
					else {state = 0; break;}
				case 31:
				...
				case 33:
					if (ch == 'a') {AddCh(); state = 5; break;}
					else if (ch == 'r') {AddCh(); state = 11; break;}
					else {state = 0; break;}
